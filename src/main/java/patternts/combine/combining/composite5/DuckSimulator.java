package patternts.combine.combining.composite5;
...
public class DuckSimulator {
    ...
    private void simulate(AbstractDuckFactory duckFactory) {
        ...
        System.out.println("\n  Duck Simulator: (whole Flock)with Goose Adapter / with decorator / with Abstract Factory/composite");
        simulate(flockDucks);

        System.out.println("\n  Duck Simulator: (mallard flock)with Goose Adapter / with decorator / with Abstract Factory/composite");
