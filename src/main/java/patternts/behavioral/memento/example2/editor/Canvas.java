...
import patternts.behavioral.memento.example2.commands.ColorCommand;
import patternts.behavioral.memento.example2.commands.MoveCommand;
    ...
    private void attachMouseListeners() {
        MouseAdapter colorizer = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                patternts.behavioral.memento.example2.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
                if (target != null) {
